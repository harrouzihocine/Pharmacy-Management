...
<head>
  ...
  <style>
    ...
    .label {
      ...
      display: grid;
      grid-template-columns: 20mm 19mm;
      gap: 0.5mm;
...
<body>    <div class="label">
      <div class="main-section">
        <div class="header">
          ...
          <div class="med-name">${stock.designation}</div>
        </div>
        <div class="barcode-section">
          <div class="barcode">
            <img 
              src="${stock.barcode}" 
              alt="QR Code"
              onerror="this.onerror=null; this.src='data:image/svg+xml,<svg xmlns=\\'http://www.w3.org/2000/svg\\' width=\\'300\\' height=\\'300\\' viewBox=\\'0 0 300 300\\'><rect width=\\'100%\\' height=\\'100%\\' fill=\\'%23f8f9fa\\'/><text x=\\'50%\\' y=\\'50%\\' font-size=\\'12\\' fill=\\'%23dc3545\\' text-anchor=\\'middle\\'>No QR</text></svg>'"
            />
            
          </div>
        </div>
        <div class="barcode-number" style="font-size: 4px; text-align: center;">
              ${stock.originalBarcode || '-'}
            </div>
      </div>
      ...
      <div class="info-section">
        <div class="info-group">
          ...
          <span class="info-value">${stock.batchNumber || '-'}</span>
        </div>
        
        <div class="info-group">
          <span class="info-label">EXP</span>
          <span class="info-value">${stock.expiryDate ? formatDate(stock.expiryDate) : '-'}</span>
        </div>
