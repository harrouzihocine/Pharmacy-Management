...
const {
 ...
 .post(  isLoggedIn,isPharmacienPrincipal,catchAsync(createFromEmptyFactureProforma));
  ...
  router.route("/approvisionnement/BE/transferToStorage/:BEID").post( isLoggedIn,isPharmacienPrincipal,catchAsync(transferBEToStorage))
  router.route("/approvisionnement/BE/updateBarCode/:itemId").post( isLoggedIn,isPharmacienPrincipal,catchAsync(updateBarCode))
